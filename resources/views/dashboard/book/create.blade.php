        ...
        <div class="mx-auto max-w-5xl rounded-xl bg-white p-6 shadow-lg lg:p-8">
            ...
            <form action="{{ route('dashboard.book.store') }}" method="POST" class="w-full">
                ...
                <div class="grid gap-5 md:grid-cols-3">
                    <div class="flex max-w-screen-lg flex-col space-y-5 md:col-span-2">
                        <div>
                    ...
                    <div class="flex flex-col space-y-5 md:mt-0 md:w-full">

                        <div class="flex h-full flex-col">
                            <label class="block text-sm text-gray-600" for="author">Дисциплина</label>
                            <textarea id="disciple" name="disciple"
                                class="h-full w-full rounded border-gray-400 bg-gray-200 px-5 py-2 leading-normal text-gray-700 focus:border-primary-500 focus:ring-2 focus:ring-primary-200"
                    ...
                    <div class="flex justify-center md:col-span-3 md:mt-0">
                        <button type="submit"
                            class="mx-auto rounded bg-secondary-500 px-10 py-2 tracking-wider text-white hover:bg-secondary-400">
                            Отправить
                        </button>
                    </div>
                </div>
