<template>
    <div class="w-full mx-auto overflow-auto rounded-lg shadow-xl">
        <table class="table-auto w-full bg-white text-xs">
            ...
            >
                <tr>
                    <th scope="col" class="text-center py-3 px-4">№ в плане</th>
                    <th scope="col" class="text-center py-3 px-4">Факультет</th>
                    <th scope="col" class="text-center py-3 px-4">Авторы</th>
                    ...
                    <th scope="col" class="text-center py-3 px-4">Статус **</th>
                </tr>
            </thead>
            <tbody>
                <tr
