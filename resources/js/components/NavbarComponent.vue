    ...
    <div id="navbar"
        ...
        <button @click="isOpen = !isOpen" type="button"
            ...
            <svg class="h-8 w-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path v-show="isOpen" fill-rule="evenodd" clip-rule="evenodd"
                    d="M18.278 16.864a1 1 0 0 1-1.414 1.414l-4.829-4.828-4.828 4.828a1 1 0 0 1-1.414-1.414l4.828-4.829-4.828-4.828a1 1 0 0 1 1.414-1.414l4.829 4.828 4.828-4.828a1 1 0 1 1 1.414 1.414l-4.828 4.829 4.828 4.828z" />
                <path v-show="!isOpen" fill-rule="evenodd"
        ...
        <div class="flex items-center flex-shrink-1">
            <a class="flex items-center title-font" :href="homeUrl">
                <img src="/images/sochi-gu.png" alt="" />
        ...
        <div class="w-full flex-grow lg:flex lg:w-auto lg:items-center"
            ...
            <ul
                ...
                <li class="mr-3 ml-auto w-max">
                    <a class="inline-block rounded-lg px-4 py-2 no-underline hover:bg-primary-500 hover:text-white"
                        :href="homeUrl" @click="isOpen = false">
                        Главная
                    </a>
                </li>
                <li class="relative mr-3 ml-auto lg:ml-0 w-max" v-for="(menu, index) in menus" :key="index"
                    @click="menu.dropdown.value = !menu.dropdown.value" @mouseover="menu.dropdown.value = true"
                    ...
                    <button
                        ...
                        <svg class="mr-1 lg:ml-1 lg:mr-0 h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20">
                    ...
                    <div v-show="menu.dropdown.value"
                ...
                <li class="mr-3 ml-auto lg:ml-0 w-max">
                    <a class="inline-block rounded-lg px-4 py-2 no-underline hover:bg-primary-500 hover:text-white"
                        :href="electronicEditions" @click="isOpen = false">
                        Каталог ЭИ
                    </a>
                </li>
                <li class="mr-3 ml-auto lg:ml-0 w-max">
                    <a class="inline-block rounded-lg px-4 py-2 no-underline hover:bg-primary-500 hover:text-white"
                        :href="price" @click="isOpen = false">
                        Прайс-лист
                    </a>
                </li>
